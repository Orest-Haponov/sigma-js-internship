...
## [Project contracts](./contracts/SecutorContracts.yaml)

## Get projects (GET request)

- Endpoint: http://{project_host}/project/{userId}
- Request:
...
- Endpoint: http://{project_host}/project
- Request:
...
- Endpoint: http://{project_host}/project/{projectId}
- Request:
